frappe.query_reports["Sales Day wise Tax Report"] = {
...
function include_checkbox_filters(report) {
	if (report._sales_day_wise_tax_report_checkbox_filters_included) {
		return;
	}
	...
	report._sales_day_wise_tax_report_checkbox_filters_included = true;
}
