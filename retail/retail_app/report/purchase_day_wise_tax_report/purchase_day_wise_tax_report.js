frappe.query_reports["Purchase Day wise Tax Report"] = {
...
function include_checkbox_filters(report) {
	if (report._purchase_day_wise_tax_report_checkbox_filters_included) {
		return;
	}
	...
	report._purchase_day_wise_tax_report_checkbox_filters_included = true;
}
