frappe.query_reports["Supplier Wise Returns"] = {
	filters: [
		...
		{ fieldname: "item_code", label: __("Item"), fieldtype: "MultiSelectList", options: "Item", get_data: (txt) => frappe.db.get_link_options("Item", txt) },
