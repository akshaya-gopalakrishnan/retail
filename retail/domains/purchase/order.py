...
from retail.domains.transactions.vat import (
	apply_transaction_vat_taxes,
	ensure_transaction_vat_rate_fields,
	get_purchase_item_vat_rate,
	get_transaction_item_vat_rate,
	recalculate_vat_totals_for_document,
	set_vat_rates,
)
...
def ensure_purchase_order_vat_rate_fields():
	"""Compatibility wrapper for the old hook path."""
	ensure_transaction_vat_rate_fields()
